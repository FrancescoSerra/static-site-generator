error id: file://<WORKSPACE>/src/main/scala/org/scalabridge/sitegen/domain/model.scala:`<none>`.
file://<WORKSPACE>/src/main/scala/org/scalabridge/sitegen/domain/model.scala
empty definition using pc, found symbol in pc: `<none>`.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -eu/timepit/refined/types/all/NonEmptyString#
	 -NonEmptyString#
	 -scala/Predef.NonEmptyString#
offset: 242
uri: file://<WORKSPACE>/src/main/scala/org/scalabridge/sitegen/domain/model.scala
text:
```scala
...
object model {
  ...
  final case class H2(value: NonEmpty@@String) extends AST
